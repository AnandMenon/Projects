...
public class GroupMessengerProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse(AUTHORITY+"/"+GroupMessengerDbHelper.dbName);
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
    	...
    	Cursor c = db.query(dbHelper.tableName, projection, selection, selectionArgs, null, null, sortOrder);
